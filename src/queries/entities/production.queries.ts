...
export const productionQueries = gql`
  ...
  fragment fullProduction on Production {
    intialValues {
      typePillLabel: keyValue(
        key: "type"
        source: typePillLabel
        index: 0
        formatter: "pill|auto"
      )
      ...
      column {
        ...
        elements {
            ...
            Affiches: panels {
              ...
              Affiches: entityListElement {
                ...
                customBulkOperations(
                  input: "GetBulkOperationsForCompletenessAssetInProduction"
                )
              }
            }
            Scenebeelden: panels {
          ...
          Notifications: entityListElement {
            ...
            customBulkOperations(
              input: "GetBulkOperationsForNotificationsInProduction"
            )
          }
  ...
  query GetAssetsWithTypeAfficheFilters($entityType: String!) {
    EntityTypeFilters(type: $entityType) {
      advancedFilters {
        type: advancedFilter(type: type, operator: and) {
          type
          defaultValue(value: "asset")
          hidden(value: true)
        }
